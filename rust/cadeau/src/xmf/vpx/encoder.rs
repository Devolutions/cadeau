...
impl<'encoder> Iterator for PacketIterator<'encoder> {
    ...
    fn next(&'_ mut self) -> Option<Self::Item> {
        ...
        // SAFETY: XmfVpxEncoder_GetPacket will always return a valid pointer or null,the null case
        // is handled above.
        // The pointer is also generated by the iterator, hence it is safe to call
